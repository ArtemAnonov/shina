...
let slider_about = new Swiper('.partners-slider__content', {
	/*
	effect: 'fade',
	autoplay: {
		delay: 3000,
	...
	*/
	...
	// Arrows
	navigation: {
		nextEl: '.partners-slider .partners-slider__arrow_prev',
		prevEl: '.partners-slider .partners-slider__arrow_next',
	},
...
function menu_close() {
	let iconMenu = document.querySelector(".menu__burger");
	let menuBody = document.querySelector(".menu__menu");
	...
	function animOnScroll() {
		for (let index = 0; index < animItems.length; index++) {
			...
			if ((pageYOffset > animItemOffset - animItemPoint) && pageYOffset < (animItemOffset + animItemHeight)) {
                ...
                // if (animItem.classList.contains('_anim-back') && (pageYOffset > (animItemOffset + animItemHeight*1/6))) {
...
function headerActive (){
	...
	if (pixelsOS > 100 && pixelsOS > scrollPrev){
...
let selectSliderSlider = document.querySelector('.select-slider__slider');
let selectSliderValue = document.querySelector('.select-slider__value');
selectSliderValue.innerHTML = arr1[0]; 


let radiusArr=document.querySelectorAll('.radius');
// radiusArr[o].style.opacity = "1";
// radiusArr[o].style.fontWeight = "800";

selectSliderSlider.oninput = function(){
	let sssValue = selectSliderSlider.value;
	for(p=0;p<radiusArr.length;p++){
		if(sssValue == p){
			selectSliderValue.innerHTML = arr1[p];	
		}
	}
	for(o=0;o<radiusArr.length;o++){

		if(sssValue == o){
			radiusArr[o].style.opacity = 1;
		}else{
			radiusArr[o].style.opacity = 0.5;
		}
	}
}
...
// 				targetElement.closest('.menu-footer').classList.toggle('_hover');
// 			}
// 		}
// 	}
// }
